...
As a data engineer, you'll implement Infrastructure as Code practices using Terraform. 

1. Familiarize yourself with Terraform - [Source](https://developer.hashicorp.com/terraform/tutorials)

1. Create a basic file structure inside the `terraform` folder at the root directory - [Source](https://medium.com/@mariammbello/terraform-beginner-cheat-sheet-understanding-the-basics-and-structure-881a496d6211)
1. Authenticate to Databricks using Terraform and provision the dev schema inside your catalog (💡While service principals are the recommended authentication method for production use, you'll use personal access tokens due to Databricks Free Edition limitations) -[Source](https://registry.terraform.io/providers/databricks/databricks/latest/docs)
...
- Terraform files (`provider.tf`, `variables.tf`, `main.tf`) with proper structure
